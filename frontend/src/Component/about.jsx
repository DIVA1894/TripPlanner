...
function About() {
  return (
    <div className="container mx-auto px-4 py-10 bg-gray-50 shadow-lg rounded-lg mt-8">
      <h1 className="text-4xl font-bold text-blue-900 mb-6 text-center border-b-4 border-blue-600 pb-4">
        About Us
      </h1>
      <p className="text-lg text-gray-700 leading-relaxed mb-8 text-center px-6">
        Welcome to <span className="font-bold text-blue-600">Travigo</span>,
        your ultimate trip planning companion! Our mission is to make travel
